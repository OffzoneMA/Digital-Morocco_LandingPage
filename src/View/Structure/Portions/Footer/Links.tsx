    ...
    return (
        <Container>
            ...
            <section>
                ...
                <a href={`https://app.digitalmorocco.net/?lang=${currentLanguage}`} target='_blank' rel="noreferrer"><span><Lang>Startup</Lang></span></a>
                <a href={`https://app.digitalmorocco.net/?lang=${currentLanguage}`} target='_blank'><span><Lang>Investor</Lang></span></a>
                <a href={`https://app.digitalmorocco.net/?lang=${currentLanguage}`} target='_blank'><span><Lang>Company</Lang></span></a>
                {/* <a href={`https://app.digitalmorocco.net/?lang=${currentLanguage}`}><span><Lang>Startup</Lang></span></a>
                <a href={`https://app.digitalmorocco.net/?lang=${currentLanguage}`}><span><Lang>Investor</Lang></span></a>
                <a href={`https://app.digitalmorocco.net/?lang=${currentLanguage}`}><span><Lang>Company</Lang></span></a> */}
            ...
            <section>
                ...
                <div id="social">
                    <a href='https://www.facebook.com/profile.php?id=100093146815005' target='_blank'>
                    ...
                    <a href='https://www.linkedin.com/company/digital-morocco/' target='_blank'>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href='https://www.instagram.com/digital.morocco/' target='_blank'>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
