...
// @ts-ignore
import regularFont from '../Appearance/Fonts/DMSans-Regular.ttf'
// @ts-ignore
import mediumFont from '../Appearance/Fonts/DMSans-Medium.ttf'
// @ts-ignore
import boldFont from '../Appearance/Fonts/DMSans-Bold.ttf'
// @ts-ignore
...
const ViewTicketPDF: React.FC<TicketProps> = (props) => {
  const {
  ...
  const generateQRCodeImageSource = async (data: string): Promise<string> => {
    try {
